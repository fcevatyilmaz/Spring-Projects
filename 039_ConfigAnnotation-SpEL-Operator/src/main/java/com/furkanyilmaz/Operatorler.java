...
public class Operatorler {
	...
	public double getAddStringTest() {
		return addStringTest;
	}
	public void setAddStringTest(double addStringTest) {
	...
	public double getExponentionalTest() {
		return exponentionalTest;
	}
	public void setExponentionalTest(double exponentionalTest) {
		this.exponentionalTest = exponentionalTest;
	}
